...
let keyBindings = [
    CGEventFlags.maskControl.rawValue: [
        ...
        KeyCodes.f: KeyBinding(metas: nil, keyCode: .right),
        KeyCodes.b: KeyBinding(metas: nil, keyCode: .left),
    ...
    CGEventFlags.maskControl.rawValue | CGEventFlags.maskShift.rawValue: [
        ...
        KeyCodes.f: KeyBinding(metas: CGEventFlags(rawValue: CGEventFlags.maskShift.rawValue), keyCode: .right),
        KeyCodes.b: KeyBinding(metas: CGEventFlags(rawValue: CGEventFlags.maskShift.rawValue), keyCode: .left),
    ...
    CGEventFlags.maskControl.rawValue | CGEventFlags.maskAlternate.rawValue: [
        ...
        KeyCodes.n: KeyBinding(metas: CGEventFlags(rawValue: CGEventFlags.maskCommand.rawValue), keyCode: .down),
    ],
]
